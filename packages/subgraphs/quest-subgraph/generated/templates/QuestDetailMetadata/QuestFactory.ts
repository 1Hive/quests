...
export class QuestCreated__Params {
  ...
  get createDeposit(): QuestCreatedCreateDepositStruct {
    return changetype<QuestCreatedCreateDepositStruct>(
      this._event.parameters[6].value.toTuple()
    );
  }

  get playDeposit(): QuestCreatedPlayDepositStruct {
    return changetype<QuestCreatedPlayDepositStruct>(
...
export class QuestCreatedCreateDepositStruct extends ethereum.Tuple {
  get token(): Address {
...
export class QuestCreatedPlayDepositStruct extends ethereum.Tuple {
  get token(): Address {
    return this[0].toAddress();
  }
...
export class QuestFactory extends ethereum.SmartContract {
  ...
  createQuest(
    ...
    let result = super.call(
      "createQuest",
      "createQuest(string,bytes,address,uint256,address,uint32,bool):(address)",
      [
        ...
        ethereum.Value.fromBoolean(_isWhiteList)
      ]
    );
