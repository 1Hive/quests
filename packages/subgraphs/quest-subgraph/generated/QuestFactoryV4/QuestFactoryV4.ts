...
export class QuestFactoryV4__depositResult {
  value0: Address;
  value1: BigInt;
...
export class QuestFactoryV4 extends ethereum.SmartContract {
  static bind(address: Address): QuestFactoryV4 {
    return new QuestFactoryV4("QuestFactoryV4", address);
  }
  ...
  deposit(): QuestFactoryV4__depositResult {
    let result = super.call("deposit", "deposit():(address,uint256)", []);

    return new QuestFactoryV4__depositResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }

  try_deposit(): ethereum.CallResult<QuestFactoryV4__depositResult> {
    ...
    return ethereum.CallResult.fromValue(
      new QuestFactoryV4__depositResult(
        value[0].toAddress(),
        value[1].toBigInt()
      )
    );
