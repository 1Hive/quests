...
export class QuestWhiteListChanged extends ethereum.Event {
  get params(): QuestWhiteListChanged__Params {
    return new QuestWhiteListChanged__Params(this);
  }
}

export class QuestWhiteListChanged__Params {
  _event: QuestWhiteListChanged;

  constructor(event: QuestWhiteListChanged) {
    this._event = event;
  }

  get whiteListPlayers(): Array<Address> {
...
export class Quest extends ethereum.SmartContract {
  ...
  isWhiteList(): boolean {
    let result = super.call("isWhiteList", "isWhiteList():(bool)", []);

    return result[0].toBoolean();
  }

  try_isWhiteList(): ethereum.CallResult<boolean> {
    let result = super.tryCall("isWhiteList", "isWhiteList():(bool)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
...
export class ConstructorCall__Inputs {
  ...
  get _questParam(): ConstructorCall_questParamStruct {
    return changetype<ConstructorCall_questParamStruct>(
...
export class ConstructorCall_questParamStruct extends ethereum.Tuple {
  get questCreator(): Address {
    return this[0].toAddress();
  }
  ...
  get aragonGovernAddress(): Address {
