...
export class QuestFactoryV3__depositResult {
  value0: Address;
  value1: BigInt;
...
export class QuestFactoryV3 extends ethereum.SmartContract {
  static bind(address: Address): QuestFactoryV3 {
    return new QuestFactoryV3("QuestFactoryV3", address);
  }
  ...
  deposit(): QuestFactoryV3__depositResult {
    let result = super.call("deposit", "deposit():(address,uint256)", []);

    return new QuestFactoryV3__depositResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }

  try_deposit(): ethereum.CallResult<QuestFactoryV3__depositResult> {
    ...
    return ethereum.CallResult.fromValue(
      new QuestFactoryV3__depositResult(
        value[0].toAddress(),
        value[1].toBigInt()
      )
    );
