...
export const networks = Object.freeze({
  ...
  goerli: {
    ...
    name: 'Goerli',
    explorer: 'etherscan',
    questsSubgraph: 'https://thegraph.com/hosted-service/subgraph/corantin/quests-goerli',
    governSubgraph: 'https://thegraph.com/hosted-service/subgraph/corantin/govern-goerli',
    tokenPairSubgraph: 'https://api.thegraph.com/subgraphs/name/uniswap/uniswap-v2',
    ...
    celesteAddress: '0x6b81e57848A75369cC5F13ED98c62412a40F19E7',
    managerAddress: '0x7375Ed576952BD6CeD060EeE2Db763130eA13bA0',
    rpcUri: 'https://goerli.infura.io/v3',
    rpcKeyEnvName: 'INFURA_API_KEY',
    isTestNetwork: true,
    stableTokens: StableTokens.goerli,
    nativeToken: TOKENS.goerli.Dai,
  },
  gnosis: {
    networkId: 'xdai',
    chainId: 100,
