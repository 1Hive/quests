...
contract QuestFactory {
    ...
    function createQuest(string calldata _content,uint256 _terminationDate,address payable _aragonGovernAddress) external {
        Quest quest = new Quest(_content,_terminationDate,_aragonGovernAddress);
...
contract Quest {
    ...
    constructor(string memory _content,uint256 _terminationDate,address payable _aragonGovernAddress) public {
        content = _content;
